...
## HOME.ICP.HEADLINE
Built for Bay Area HVAC teams that want more booked estimates

## HOME.ICP.BEST_FIT
Best fit:
- Residential HVAC (repair / install / maintenance)
- Heat pumps / ductless / furnace + AC
...
We implement the high-impact fixes: service catalog, service area precision, service pages + FAQs, Schema, listings updates, tracking.
...
#### HOME.OFFERS.A.INCLUDES
Includes:
- 6–10 minute Loom audit
- 1-page “Top 10 fixes” checklist (ranked by impact)
...
- New FAQs and job stories
- Page upgrades for clarity + conversion
- Listings monitoring/corrections
